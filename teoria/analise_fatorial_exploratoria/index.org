#+Title: Análise Fatorial Exploratória (AFE) - Química do Solo
#+Author: Gemini CLI
#+Date: 2026-06-07
#+Language: pt-br
...
# Ao executar via Org-mode, o caminho relativo é em relação ao diretório do arquivo .org
# Se executado externamente, certifique-se de que o arquivo .xlsx esteja no local correto
input_file = '../../quimica_do_solo.xlsx'
output_file = 'dados_padronizados.csv'
