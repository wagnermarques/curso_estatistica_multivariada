...
- *Fator 1*: Fortemente relacionado a Mg, Ca (positivo) e Al3+, H+Al
  (negativo).
  Segundo o Gemini, pode ser interpretado como um fator de *Fertilidade vs Acidez*.

- *Fator 2*:
  Fortemente relacionado a Mn e S (negativo) e Fe (positivo).
  Segundo o Gemini, pode estar relacionado a processos de *Redox ou Micronutrientes específicos*.
